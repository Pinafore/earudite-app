            ...
            if type(submission) is list:
                ...
                for batch_item in submission:
                    ...
                    if "err" in result:
                        ...
                        batch_has_error = True
                        break
                    print(total_accuracy_fraction, result["accuracyFraction"])
                    total_accuracy_fraction[0] += 1 #result["accuracyFraction"][0]
                    total_accuracy_fraction[1] += 1 #result["accuracyFraction"][1]
